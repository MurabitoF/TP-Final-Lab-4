          ...
          <div class="container">
               ...
               <form action="<?php echo FRONT_ROOT ?>JobOffer/Edit" enctype="multipart/form-data" method="post" class="bg-light-alpha p-5">
                    ...
                    <div class="row my-3">
                         ...
                         <div class="col-md-6">
                              <img alt="preview flyer" id="previewFlyer" class="<?php echo ($jobOffer->getImgFlyer()) ? "" : "visually-hidden" ?> preview-flyer" src="<?php echo ($jobOffer->getImgFlyer()) ? "../" . UPLOADS_PATH . "img/flyer/" . $jobOffer->getImgFlyer() : "" ?>">
                         </div>
                    </div>
